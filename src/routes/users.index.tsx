                      ...
                      return (
                        <tr key={u.id} className="group transition-colors hover:bg-muted/30 bg-background">
                          ...
                          <td className="px-5 py-3 font-medium text-foreground">
                            {u.fullName || <span className="text-xs italic text-muted-foreground">No Profile Data</span>}
                          </td>
          ...
          {userToView && (
            <div className="space-y-4 py-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-lg font-bold">{userToView.fullName || "No Name Provided"}</h3>
